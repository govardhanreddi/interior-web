...
<div className="follow-us-section pt-5 pb-5">
    ...
    <div className="image-div">
      ...
      <img src="images/mainlogo.jpg"
            ...
            <a href="public/images/AARA Brouchre.pdf" download><button className='info2-button'>Download Now</button></a>
            </div>
...
//                 />
//                 <h1 className="wcu-card-title mt-3">Personalised designs</h1>
...
//                 />
//                 <h1 className="wcu-card-title mt-3">Flat 10-year warranty¹</h1>
//                 <p className="wcu-card-description">
//                   Experience peace of mind with our comprehensive 10-year warranty¹. We stand behind the quality and durability of our products, providing long-term protection and support. Our warranty covers all major defects and issues, ensuring that you can enjoy our products with confidence for a decade.
//                 </p>
//               </div>
...
//                 />
//                 <h1 className="wcu-card-title mt-3">Transparent pricing</h1>
//                 <p className="wcu-card-description">
//                   Say goodbye to hidden costs and unexpected charges. 
//                   Our transparent pricing model ensures that you know exactly 
//                   what you’re paying for. We provide clear and detailed cost
...
//             <div className="menu-item-card shadow p-3 mb-3">
//               <img
//                 src="https://images.livspace-cdn.com/w:320/h:234/dpr:2/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/in/unification-home-1663681501-pVo75/desktop-1663681517-hulYi/offerings-interiors-1682066909-GMFDK/kitchen-1682066986-P6rm3.jpg"
//                 className="menu-item-image w-100"
//                 alt="Modular Kitchens"
//               />
//               <h1 className="menu-card-title">Modular Kitchens</h1>
//               <a href="#" className="menu-item-link">
//                 View All
//                 <svg width="16px" height="16px" viewBox="0 0 16 16" className="bi bi-arrow-right" fill="#d0b200" xmlns="http://www.w3.org/2000/svg">
//                   <path
...
//             <div className="menu-item-card shadow p-3 mb-3">
//               <img
//                 src="https://images.livspace-cdn.com/w:320/h:234/dpr:2/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/in/unification-home-1663681501-pVo75/desktop-1663681517-hulYi/offerings-interiors-1682066909-GMFDK/wardrobe-1682066985-hq3ov.jpg"
//                 className="menu-item-image w-100"
//                 alt="Modular Wardrobes"
//               />
//               <h1 className="menu-card-title">Modular Wardrobes</h1>
//               <a href="#" className="menu-item-link">
//                 View All
//                 <svg width="16px" height="16px" viewBox="0 0 16 16" className="bi bi-arrow-right" fill="#d0b200" xmlns="http://www.w3.org/2000/svg">
//                   <path
...
//             <div className="menu-item-card shadow p-3 mb-3">
//               <img
//                 src="https://images.livspace-cdn.com/w:320/h:234/dpr:2/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/in/unification-home-1663681501-pVo75/desktop-1663681517-hulYi/offerings-interiors-1682066909-GMFDK/falses-ceiling-1682066988-XAMo2.jpg"
//                 className="menu-item-image w-100"
//                 alt="False Ceiling"
//               />
//               <h1 className="menu-card-title">False Ceiling</h1>
//               <a href="#" className="menu-item-link">
//                 View All
//                 <svg width="16px" height="16px" viewBox="0 0 16 16" className="bi bi-arrow-right" fill="#d0b200" xmlns="http://www.w3.org/2000/svg">
//                   <path
...
//         </div>
//       </div>
//       <div className='social-media' id="followUsSection">
//         <div className='follow-us'>
//           <h1 className='follow-us-heading'>Follow Us</h1>
//           <p className='follow-us-caption'>Follow us on our social media profiles to stay updated</p>
//         </div>
//         <div className='social-media-icons'>
//           <a href='#'>
//             <img src='images/facebook.svg' alt='Facebook' className='social-media-icon' />
//           </a>
//           <a href='#'>
//             <img src='images/instagram.svg' alt='Instagram' className='social-media-icon' />
//           </a>
//           <a href='#'>
//             <img src='images/twitter.svg' alt='Twitter' className='social-media-icon' />
//           </a>
//           <a href='#'>
//             <img src='images/linkedin.svg' alt='LinkedIn' className='social-media-icon' />
//           </a>
//         </div>
//       </div>
...
//               <p className="footer-text">Designed by You</p>
//             </div>
//           </div>
//         </div>
//       </footer>
